...
echo -e "${Green_font}
#=================================================
# Project:  tcp_nanqinlang lkl-rinetd
# Platform: --Debian&&Ubuntu --openvz --singleNIC
# Author: nanqinlang
...
download(){
	wget --no-check-certificate https://raw.githubusercontent.com/tcp-nanqinlang/lkl-rinetd/master/module/rinetd
